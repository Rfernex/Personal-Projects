...
* --- Step 4: Plot Side-by-Side (Yearly) ---
foreach s in 1 2 {
    twoway ///
...
graph combine g_y_1 g_y_2, ///
    ...
    note("Source: Enquête Emploi (2013-2020). Left: Men, Right: Women.") ///
    rows(1)
...
* --- Step 4: Plot Side-by-Side (Quarterly) ---
foreach s in 1 2 {
    twoway ///
...
graph combine g_q_1 g_q_2, ///
    ...
    note("Source: Enquête Emploi (2013-2020). Navy=W+W, Maroon=W+S, Green=S+W, Orange=S+S") ///
    rows(1)
