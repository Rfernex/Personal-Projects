...
gen byte is_type1 = (plur_type_INSEE == 1) // Salaried + Salaried
gen byte is_type2 = (plur_type_INSEE == 2) // Salaried + Non-Salaried
gen byte is_type3 = (plur_type_INSEE == 3) // Non-Salaried + Salaried
gen byte is_type4 = (plur_type_INSEE == 4) // Non-Salaried + Non-Salaried
...
* -- Group B: Main Job is Non Salaried --
forvalues c = 3/4 {
...
twoway ///
    ...
    legend(order(5 "Salaried + Salaried (among Salaried)" 6 "Salaried + Non-Salaried (among Salaried)" ///
                 7 "Non-Salaried + Salaried (among Non-Salaried)" 8 "Non-Salaried + Non-Salaried (among Non-Salaried)") ///
           rows(2) position(6)) ///
...
graph export "output/plract_SNS_REL_yearly.png", replace width(2000)
...
graph export "output/plract_SNS_REL_quarterly.png", replace width(2000)
