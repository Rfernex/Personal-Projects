...
gen byte is_type1 = (plur_type_INSEE == 1)
gen byte is_type2 = (plur_type_INSEE == 2)
gen byte is_type3 = (plur_type_INSEE == 3)
gen byte is_type4 = (plur_type_INSEE == 4)
...
twoway ///
    ...
    legend(order(5 "Salaried + Salaried" 6 "Salaried+ Non-Salaried" 7 "Non-Salaried + Salaried" 8 "Non-Salaried + Non-Salaried") rows(2) position(6)) ///
...
graph export "output/plract_SNS_ABS_yearly.png", replace width(2000)
...
graph export "output/plract_SNS_ABS_quarterly.png", replace width(2000)
