...
gen byte is_type1 = (plur_ae_type == 1)
gen byte is_type2 = (plur_ae_type == 2)
gen byte is_type3 = (plur_ae_type == 3)
gen byte is_type4 = (plur_ae_type == 4)
...
twoway ///
    ...
    legend(order(5 "Other + Other" 6 "Other + Entrepreneur" 7 "Entrepreneur + Other" 8 "Entrepreneur + Entrepreneur") rows(1) position(6)) ///
...
graph export "output/plract_AUTO&OTHER_ABS_yearly.png", replace width(2000)
...
graph export "output/plract_AUTO&OTHER_ABS_quarterly.png", replace width(2000)
